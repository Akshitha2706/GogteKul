...
export default function FamilyFormPage() {
  ...
  useEffect(() => {
    const isAliveStatus = formValues.personalDetails?.isAlive;
    if (isAliveStatus !== "no") {
      if (formValues.personalDetails?.dateOfDeath) {
        setValue("personalDetails.dateOfDeath", "");
      }
      if (formValues.personalDetails?.confirmDateOfDeath) {
        setValue("personalDetails.confirmDateOfDeath", "");
      }
    }
  }, [
    formValues.personalDetails?.isAlive,
    formValues.personalDetails?.dateOfDeath,
    formValues.personalDetails?.confirmDateOfDeath,
    setValue,
  ]);
    ...
    () => [
      {
        ...
        canProceed: () => Boolean(formValues.personalDetails?.vansh),
        render: () => (
