...
const normalizeEventDocument = (doc) => {
  ...
  return {
    ...
    eventName: trimmedStringOrEmpty(doc.eventName),
    eventType: trimmedStringOrEmpty(doc.eventType),
    date: toISOStringOrNull(doc.date),
    time: trimmedStringOrEmpty(doc.time),
...
app.post('/api/events', (req, res, next) => {
  ...
  try {
    ...
    const { title, description, eventType, fromDate, toDate, fromTime, toTime, priority } = req.body;
